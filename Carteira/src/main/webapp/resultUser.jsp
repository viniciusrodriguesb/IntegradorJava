			...
			<div class="col-md-6 m-auto">
				<table class="table">
					...
					<tbody>
						...
						Usuario u = usr.buscarId((int) (session.getAttribute("usuarioId")));
						%>
						...
						<tr>
							...
							<td><svg onclick="confirmarExclusao(<%=u.getId()%>)"
									xmlns="http://www.w3.org/2000/svg" width="16" height="16"
							...
							<td><a href="PrepararAlteracaoUsuario?id=<%=u.getId()%>">
