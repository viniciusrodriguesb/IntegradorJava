...
public class UsuarioDAO {
	...
	// ALTERAÇÃO DE DADOS DO USUÁRIO NO BANCO
	public boolean alterarUsuario(Usuario usuario) {
		boolean resultado = true;
		int retornoQuery;

		cnx = DAO.createConnection();
		String sql = "UPDATE tb_login SET nome=?, usuario=?, senha=? WHERE id=?";
	...
	// INCLUSÃO DE DADOS DO USUÁRIO NO BANCO
	public boolean incluirUsuario(Usuario usuario) {
		boolean resultado = true;
		int retornoQuery;

		cnx = DAO.createConnection();
		String sql = "INSERT INTO tb_login(nome, usuario, senha) VALUES(?, ?, ?)";
	...
	// EXCLUSÃO DE DADOS DO USUÁRIO NO BANCO
	...
	// CONSULTA DOS DADOS NO BANCO PARA VALIDAÇÃO
	...
	// LISTAR OS DADOS QUE ESTÃO NO BANCO DE USUÁRIOS
